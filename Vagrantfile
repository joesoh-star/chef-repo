...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  #
   config.vm.provision :chef_client do |chef|
     chef.chef_server_url = "https://api.opscode.com/organizations/chilis"
     chef.validation_key_path = ".chef/chilis-validator.pem"
   end
  #
  ...
  #
  #   chef.validation_client_name = "chilis-validator"
